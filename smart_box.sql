...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 20 sep. 2019 à 17:29
...
ALTER TABLE `box_contient_colis`
  ...
  ADD CONSTRAINT `box_contient_colis_ibfk_4` FOREIGN KEY (`idCasier`) REFERENCES `casier` (`idcasier`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
